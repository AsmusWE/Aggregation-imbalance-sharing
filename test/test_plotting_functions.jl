...
#
# Only the pure helpers are covered. plot_results, plot_cost_difference and
# plot_socialized_vs_individualized render and display figures rather than returning
# values, so they are verified by inspecting their output rather than by assertion.
...
@testset "Plotting_functions.jl" begin
    @testset "create_alphabetic_client_mapping" begin
        ...
        # Beyond 26, codes stay two characters wide
