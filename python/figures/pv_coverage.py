"""Per-consumer total demand and the share of it covered by PV production.

Client names are kept as they are internally; the alphabetic mapping is applied only to the
x-axis tick labels."""
