...
# Shared color palette for cost-gradient plots (low cost -> high cost), also used by
# scripts/Plotting_main.jl and scripts/FigureScripts/*.jl.
...
# Shared text/size style for small paper-sized figures, also used by
...
function plot_results(
    ...
    # Clients are used in the order given; callers sort them beforehand
    plot_keys = clients
